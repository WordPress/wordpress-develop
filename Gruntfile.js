		...
		copy: {
			...
			'admin-js': {
				files: {
					...
					[ WORKING_DIR + 'wp-admin/js/easter-egg.js' ]: [ './src/js/_enqueues/admin/easter-egg.js' ],
					[ WORKING_DIR + 'wp-admin/js/easter-egg-loader.js' ]: [ './src/js/_enqueues/admin/easter-egg-loader.js' ],
