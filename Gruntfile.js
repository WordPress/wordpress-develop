		...
		copy: {
			...
			'includes-js': {
				files: {
					...
					[ WORKING_DIR + 'wp-includes/js/wp-delayed-inline-script-loader.js' ]: [ './src/js/_enqueues/lib/delayed-inline-script-loader.js' ],
		...
		patch:{
			options: {
				file_mappings: {
					...
					'src/wp-includes/js/wp-delayed-inline-script-loader.js': 'src/js/_enqueues/lib/delayed-inline-script-loader.js',
