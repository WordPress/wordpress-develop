		...
		copy: {
			...
			'includes-js': {
				files: {
					...
					[ WORKING_DIR + 'wp-includes/js/wp-deprecate-l10n-object.js' ]: [ './src/js/_enqueues/wp/deprecate-l10n-object.js' ],
		...
		patch:{
			options: {
				file_mappings: {
					...
					'src/wp-includes/js/wp-deprecate-l10n-object.js': 'src/js/_enqueues/wp/deprecate-l10n-object.js',
