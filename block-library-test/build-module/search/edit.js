...
export default function SearchEdit({
  ...
  const wasJustInsertedIntoNavigationBlock = useSelect(select => {
    const {
  ...
  }, (isButtonPositionInside || isButtonPositionOutside || hasOnlyButton) && createElement(Fragment, null, renderTextField(), renderButton()), hasNoButton && renderTextField()));
}
