...
function CoverEdit({
  ...
  if (!useFeaturedImage && !hasInnerBlocks && !hasBackground) {
    return createElement(Fragment, null, blockControls, inspectorControls, isSelected && createElement(ResizableCoverPopover, {
      ...resizableCoverProps
  ...
  return createElement(Fragment, null, blockControls, inspectorControls, createElement(TagName, {
    ...blockProps,
    ...
    ...innerBlocksProps
  })), isSelected && createElement(ResizableCoverPopover, {
    ...resizableCoverProps
  }));
}
