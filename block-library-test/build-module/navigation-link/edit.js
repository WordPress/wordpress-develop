...
export default function NavigationLinkEdit({
  ...
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(ToolbarGroup, null, createElement(ToolbarButton, {
    ...
    text: tooltipText
  }, createElement("span", null, missingText))) : createElement(Fragment, null, !isInvalid && !isDraft && !isLabelFieldFocused && createElement(Fragment, null, createElement(RichText, {
    ref: ref,
    identifier: "label",
  ...
  `${decodeEntities(label)} ${isInvalid || isDraft ? placeholderText : ''}`.trim())))), isLinkOpen && createElement(LinkUI, {
    clientId: clientId,
    link: attributes,
