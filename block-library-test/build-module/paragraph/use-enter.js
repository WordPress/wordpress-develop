...
import { hasBlockSupport, createBlock, getDefaultBlockName } from '@wordpress/blocks';
  ...
  return useRefEffect(element => {
    function onKeyDown(event) {
      ...
      batch(() => {
        ...
        insertBlock(createBlock(defaultBlockName), blockIndex + 1, getBlockRootClientId(wrapperClientId), true);
      });
    }
