...
import { BlockCaption, MediaPlaceholder, MediaUpload, MediaUploadProgress, MEDIA_TYPE_IMAGE, BlockControls, InspectorControls, BlockStyles, store as blockEditorStore, blockSettingsScreens, RichText } from '@wordpress/block-editor';
...
export class ImageEdit extends Component {
  ...
  accessibilityLabelCreator(caption) {
    ...
    return RichText.isEmpty(caption) ? /* translators: accessibility text. Empty image caption. */
    'Image caption. Empty' : sprintf( /* translators: accessibility text. %s: image caption. */
  ...
  getAltTextSettings() {
    ...
    return createElement(BottomSheetTextControl, {
      ...
      label: __('Alt Text'),
      icon: textColor,
      footerNote: createElement(Fragment, null, __('Describe the purpose of the image. Leave empty if decorative.'), ' ', createElement(FooterMessageLink, {
  ...
  render() {
    ...
    const imageContainerStyles = [context?.fixedHeight && styles.fixedHeight];
    ...
    const getImageComponent = (openMediaOptions, getMediaOptions) => createElement(Badge, {
      ...
      renderContent: ({
        ...
        }, isFetchingImage && this.showLoadingIndicator(), createElement(Image, {
