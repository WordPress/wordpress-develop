...
export default function PostExcerptEditor({
  ...
  if (!postType || !postId) {
    return createElement(Fragment, null, createElement(BlockControls, null, createElement(AlignmentToolbar, {
      ...
      ...blockProps
    }, createElement("p", null, __('This block will display the excerpt.'))));
  }
  ...
  const excerptContent = isEditable ? createElement(RichText, {
    ...
    className: excerptClassName
  }, !isTrimmed ? rawOrRenderedExcerpt || __('No excerpt found') : trimmedExcerpt + ELLIPSIS);
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(AlignmentToolbar, {
    value: textAlign,
    onChange: newAlign => setAttributes({
      textAlign: newAlign
    ...
    ...blockProps
  }, excerptContent, !showMoreOnNewLine && ' ', showMoreOnNewLine ? createElement("p", {
