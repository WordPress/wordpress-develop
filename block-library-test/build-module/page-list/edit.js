...
function BlockContent({
  ...
  if (blockList.length === 0) {
    ...
    if (parentPageDetails?.title?.rendered) {
      return createElement("div", {
        ...blockProps
      }, createElement(Warning, null, sprintf(
...
export default function PageListEdit({
  ...
  return createElement(Fragment, null, createElement(InspectorControls, null, pagesTree.length > 0 && createElement(PanelBody, null, createElement(ComboboxControl, {
  ...
  })), allowConvertToLinks && createElement(PanelBody, {
    title: __('Edit this menu')
  }, createElement("p", null, convertDescription), createElement(Button, {
    variant: "primary",
    disabled: !hasResolvedPages,
    onClick: convertToNavigationLinks
  }, __('Edit')))), allowConvertToLinks && createElement(Fragment, null, createElement(BlockControls, {
    group: "other"
  }, createElement(ToolbarButton, {
    title: __('Edit'),
    onClick: openModal
  }, __('Edit'))), isOpen && createElement(ConvertToLinksModal, {
    onClick: convertToNavigationLinks,
    onClose: closeModal,
    disabled: !hasResolvedPages
  })), createElement(BlockContent, {
