...
The html5lib tree-construction tests are maintained by the Web Platform Tests project.
...
The `AUTHORS.rst` and `LICENSE` files document the original `html5lib-tests`
