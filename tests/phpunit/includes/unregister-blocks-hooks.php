...
remove_action( 'init', 'register_block_core_comment_author_avatar' );
...
remove_action( 'init', 'register_block_core_post_comment' );
...
remove_action( 'init', 'register_block_core_table_of_contents' );
