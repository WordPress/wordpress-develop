...
$phpunitpolyfills_autoloader = __DIR__ . '/../../../vendor/yoast/phpunit-polyfills/phpunitpolyfills-autoload.php';
if ( ! file_exists( $phpunitpolyfills_autoloader ) ) {
	echo "Error: You need to run `composer update` before running the tests. You can still use a PHPUnit phar to run them, but the dependencies DO need to be installed.\n";
	exit( 1 );
}
