...
class Tests_Post_Types extends WP_UnitTestCase {
	...
	public function test_get_post_type_object_includes_menu_icon_for_builtin_post_types() {
		$this->assertSame( 'core-admin/pin', get_post_type_object( 'post' )->menu_icon );
		$this->assertSame( 'core-admin/page', get_post_type_object( 'page' )->menu_icon );
		$this->assertSame( 'core-admin/media', get_post_type_object( 'attachment' )->menu_icon );
	}
