...
class Tests_Formatting_wpHtmlExcerpt extends WP_UnitTestCase {
	public function test_simple() {
		$this->assertEqualHTML( 'Baba', wp_html_excerpt( 'Baba told me not to come', 4 ) );
	}
	public function test_html() {
		$this->assertEqualHTML( 'Baba', wp_html_excerpt( "<a href='http://baba.net/'>Baba</a> told me not to come", 4 ) );
	}
