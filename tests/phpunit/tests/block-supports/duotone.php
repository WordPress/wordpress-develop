...
class WP_Duotone_Test extends WP_UnitTestCase {
	...
	public function data_get_slug_from_attr() {
		return array(
	...
	/**
	 * @dataProvider data_get_slug_from_attr
	 */
	public function test_get_slug_from_attr( $data_attr, $expected ) {

		$reflection = new ReflectionMethod( 'WP_Duotone', 'get_slug_from_attr' );
