...
JS;
	...
	public function test_wp_add_inline_script_before_after_concat_with_core_dependency() {
		...
		$expected .= "( window.FormData && window.FormData.prototype.keys ) || document.write( '<script src=\"http://example.org/wp-includes/js/dist/vendor/wp-polyfill-formdata.js\"></scr' + 'ipt>' );\n";
		$expected .= "</script>\n";
