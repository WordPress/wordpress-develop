 ...
 * @group notes
 *
 * @covers ::wp_get_note_plain_text
 */
class Tests_Comment_WpGetNotePlainText extends WP_UnitTestCase {
	 ...
	 */
	public function test_get_note_plain_text( string $content, string $expected ) {
		$this->assertSame( $expected, wp_get_note_plain_text( $content ) );
	}
	 ...
	 */
	public function data_get_note_plain_text() {
		return array(
