<?php
/**
 * Unit tests covering WP_REST_Batch_Controller functionality.
 *
 * @package WordPress
 * @subpackage REST_API
 * @since 5.8.0
 ...
 * @group restapi
 * @covers WP_REST_Batch_Controller
 */
class WP_Test_REST_Batch_Controller extends WP_Test_REST_TestCase {
