...
class WP_Test_REST_Schema_Initialization extends WP_Test_REST_TestCase {
	...
	private static $fixture_replacements = array(
		...
		'CommentsCollection.0.post_details.id'             => 4,
		'CommentsCollection.0.post_details.link'           => 'http://example.org/index.php?rest_route=/wp/v2/posts/4',
		'CommentModel.id'                                  => 2,
		'CommentModel.post'                                => 4,
		'CommentModel.link'                                => 'http://example.org/?p=4#comment-2',
		'CommentModel.post_details.id'                     => 4,
		'CommentModel.post_details.link'                   => 'http://example.org/index.php?rest_route=/wp/v2/posts/4',
