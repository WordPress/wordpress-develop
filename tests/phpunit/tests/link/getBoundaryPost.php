...
class Tests_Link_GetBoundaryPost extends WP_UnitTestCase {
    ...
    /**
     * Tests that `get_boundary_post()` works on non-singular pages after the fix.
	 * 
     * @ticket 22957
     */
    ...
    /**
     * Tests that `get_boundary_post()` continues to work correctly on single pages.
     *
     * @ticket 22957
     */
    ...
    /**
     * Tests that `get_boundary_post()` works on archive pages.
     *
     * @ticket 22957
     */
    ...
    /**
     * Tests that `get_boundary_post()` respects the `$in_same_term` parameter.
     *
     * @ticket 22957
     */
    ...
    /**
     * Tests that `get_boundary_post()` returns null for invalid taxonomy.
     *
     * @ticket 22957
     */
