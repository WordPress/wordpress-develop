	...
	public function data_get_adjacent_image_link() {
		return array(
			...
			'when has previous link'           => array(
				...
				'expected'                  => '<a href=\'http://' . WP_TESTS_DOMAIN . '/?attachment_id=%%ID%%\'><img width="1" height="1" src="' . _upload_get_url( 'image2.jpg' ) . '" class="attachment-thumbnail size-thumbnail" alt="" decoding="async" loading="lazy" /></a>',
			),
			...
			'when has next link'               => array(
				...
				'expected'                  => '<a href=\'http://' . WP_TESTS_DOMAIN . '/?attachment_id=%%ID%%\'><img width="1" height="1" src="' . _upload_get_url( 'image5.jpg' ) . '" class="attachment-thumbnail size-thumbnail" alt="" decoding="async" loading="lazy" /></a>',
