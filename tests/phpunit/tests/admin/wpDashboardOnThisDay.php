...
class Tests_Admin_wpDashboardOnThisDay extends WP_UnitTestCase {
	...
	public function test_widget_displays_the_requested_page() {
		...
		$this->assertMatchesRegularExpression( '/Anniversary post 11\s*<\/a>/', $output );
		$this->assertMatchesRegularExpression( '/Anniversary post 20\s*<\/a>/', $output );
		$this->assertStringNotContainsString( 'Anniversary post 1</a>', $output );
