...
class Tests_Meta_Register_Meta extends WP_UnitTestCase {
	...
	public function data_get_default_data() {
		return array(
			...
			'multiple integer with multiple ask many defaults' => array(
				array(
					'single'  => false,
					'type'    => 'integer',
			...
			'multiple integer with multiple ask default array' => array(
				array(
					'single'  => false,
					'type'    => 'integer',
					'default' => array( 123 ),
			...
			'multiple integer with single ask many defaults' => array(
				array(
					'single'  => false,
					'type'    => 'integer',
					'default' => array( 123, 456 ),
			...
			'multiple integer with single ask default array' => array(
				array(
					'single'  => false,
					'type'    => 'integer',
					'default' => array( 123 ),
