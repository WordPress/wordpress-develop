<?php
/**
 * Test _prime_options_cache().
 *
 * @group option
 *
 * @covers ::_prime_options_cache
 */
class Tests_Option_PrimeOptionsCache extends WP_UnitTestCase {

	/**
	 * Tests that _prime_options_cache() primes multiple options.
	 *
	 * @ticket 58962
	 */
	public function test_prime_options_cache() {
		...
		// Call the _prime_options_cache function to prime the options.
		_prime_options_cache( $options_to_prime );
	...
	/**
	 * Tests _prime_options_cache() with options that do not exist in the database.
	 *
	 * @ticket 58962
	 */
	...
	/**
	 * Tests _prime_options_cache() with an empty array.
	 *
	 * @ticket 58962
	 */
	...
	/**
	 * Tests that _prime_options_cache() handles an empty "notoptions" cache.
	 *
	 * @ticket 58962
	 */
	public function test_prime_options_cache_handles_empty_notoptions_cache() {
		...
		_prime_options_cache( array( 'nonexistent_option' ) );
