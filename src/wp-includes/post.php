...
/**
 * Retrieve all children of a page or any other hierarchical post type.
 *
 * By default, the children of the parent of the global `$post` are retrieved.
 * Note that `$post` is either the current post in The Loop or the post/page being
 * displayed. This function only works for hierarchical post types such as pages.
 *
 * Only children are returned, excluding "grandchildren".
 *
 * @since 2.0.0
 *
 * @see get_posts()
 ...
 *
 * @param mixed  $args   Optional. Parent ID (integer), or an array with arguments to be
 *                       passed to `get_posts`. When using an array, pass in the `post_parent`
 *                       field to determine whose children are retrieved. Default empty
