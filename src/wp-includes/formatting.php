 ...
 * @since 3.4.0
 *
 * @param string $color The color value to sanitize. Can be with or without a hash prefix.
 * @return string|null The sanitized hex color without hash prefix, empty string if input is empty, or null if invalid.
 */
