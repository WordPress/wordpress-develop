 ...
 * @since 3.4.0
 *
 * @param string $color The color value to hash. Can be with or without a hash prefix.
 * @return string The color with hash prefix if it's a valid hex color, otherwise the original value.
 */
