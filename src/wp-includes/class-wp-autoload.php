...
final class WP_Autoload {
	...
	const CLASSES_PATHS = array(
		...
		'wp_icon_collections_registry'                => 'wp-includes/class-wp-icon-collections-registry.php',
		...
		'wp_rest_icon_collections_controller'         => 'wp-includes/rest-api/endpoints/class-wp-rest-icon-collections-controller.php',
		...
		'wp_rest_view_config_controller'              => 'wp-includes/rest-api/endpoints/class-wp-rest-view-config-controller.php',
