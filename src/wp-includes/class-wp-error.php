...
class WP_Error {
	 ...
	 * @since 2.1.0
	 *
	 * @param string|int $code Optional. Retrieve messages matching code, if exists. Default empty string.
	 ...
	 * @since 2.1.0
	 *
	 * @param string|int $code Optional. Error code to retrieve message. Default empty string.
