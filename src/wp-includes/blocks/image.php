...
function block_core_image_render_lightbox( $block_content, $block, $block_instance ) {
	...
	wp_interactivity_config(
		...
		array(
			...
			'prevButtonText' => esc_html_x( 'Previous', 'previous image' ),
			'nextButtonText' => esc_html_x( 'Next', 'next image' ),
		)
	);
...
function block_core_image_print_lightbox_overlay() {
	...
	$prev_button_text = esc_attr_x( 'Previous', 'previous image' );
	$next_button_text = esc_attr_x( 'Next', 'next image' );
