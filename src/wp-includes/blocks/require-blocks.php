...
require ABSPATH . WPINC . '/blocks/comment-author-avatar.php';
...
require ABSPATH . WPINC . '/blocks/post-author-name.php';
require ABSPATH . WPINC . '/blocks/post-comment.php';
require ABSPATH . WPINC . '/blocks/post-comments.php';
require ABSPATH . WPINC . '/blocks/post-comments-count.php';
require ABSPATH . WPINC . '/blocks/post-comments-form.php';
require ABSPATH . WPINC . '/blocks/post-comments-link.php';
...
require ABSPATH . WPINC . '/blocks/table-of-contents.php';
