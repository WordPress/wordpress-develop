...
/**
 * Prints the translations of the script modules that will be printed on the page.
 *
 * @since 7.2.0
 *
 * @see WP_Script_Modules::print_script_module_translations()
 */
function wp_print_script_module_translations(): void {
	wp_script_modules()->print_script_module_translations();
}

/**
 * Prints the data associated with the script modules that will be printed on the page.
 *
 * @since 7.2.0
 *
 * @see WP_Script_Modules::print_script_module_data()
 */
function wp_print_script_module_data(): void {
	wp_script_modules()->print_script_module_data();
}

/**
 * Prints the HTML regions used by the `@wordpress/a11y` script module.
 *
 * @since 7.2.0
 *
