	...
	function( $name ) {
		...
		if ( ! $classes ) {
			$classes = array(
				...
				'WP_Block_Pattern_Categories_Registry'     => ABSPATH . WPINC . '/class-wp-block-pattern-categories-registry.php',
				'WP_Block_Patterns_Registry'               => ABSPATH . WPINC . '/class-wp-block-patterns-registry.php',
				...
				'WP_Customize_Control'                     => ABSPATH . WPINC . '/class-wp-customize-control.php',
				...
				'WP_Customize_Panel'                       => ABSPATH . WPINC . '/class-wp-customize-panel.php',
				'WP_Customize_Section'                     => ABSPATH . WPINC . '/class-wp-customize-section.php',
				'WP_Customize_Setting'                     => ABSPATH . WPINC . '/class-wp-customize-setting.php',
