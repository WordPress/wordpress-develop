...
function get_block_editor_settings( array $custom_settings, $block_editor_context ) {
	...
	if ( isset( $editor_settings['__experimentalFeatures']['color']['palette'] ) ) {
		...
		$editor_settings['colors'] = $colors_by_origin['custom'] ?? (
	...
	if ( isset( $editor_settings['__experimentalFeatures']['color']['gradients'] ) ) {
		...
		$editor_settings['gradients'] = $gradients_by_origin['custom'] ?? (
	...
	if ( isset( $editor_settings['__experimentalFeatures']['typography']['fontSizes'] ) ) {
		...
		$editor_settings['fontSizes'] = $font_sizes_by_origin['custom'] ?? (
	...
	if ( isset( $editor_settings['__experimentalFeatures']['spacing']['spacingSizes'] ) ) {
		...
		$editor_settings['spacingSizes'] = $spacing_sizes_by_origin['custom'] ?? (
