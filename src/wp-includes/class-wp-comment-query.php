...
class WP_Comment_Query {
	 ...
	 * @return array|int Array of comments, or number of comments when 'count' is passed as a query var.
	 */
	 ...
	 *
	 * @return int|int[]|WP_Comment[] Array of comments or number of found comments if `$count` argument is true.
	 */
