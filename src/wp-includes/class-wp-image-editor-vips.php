...
class WP_Image_Editor_Vips extends WP_Image_Editor {
	 ...
	 *
	 * VIPS support depends on runtime configuration and optional dependencies, so the
	 * answer has to be determined at runtime. Caching it avoids repeating the check.
	 *
	 ...
	 *
	 * The answer cannot change during a request, and the check is reached once for every
	 * mime type that is asked about, so it is made once.
	 *
	 * @since 7.2.0
	 *
	 * @param array $args
