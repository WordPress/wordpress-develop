...
function Header({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Stack, { direction: "column", className: style_default3.header, children: [
...
function Stage() {
  ...
  const [isStyleBookOpened, setIsStyleBookOpened] = (0, import_element4.useState)(
