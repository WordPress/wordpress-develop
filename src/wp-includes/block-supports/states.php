 ...
 */
function wp_get_state_declarations_with_fallback_dimension_styles( $declarations ) {
	if ( ! is_array( $declarations ) ) {
		return $declarations;
	}
...
function wp_render_block_states_support( $block_content, $block ) {
	...
	foreach ( $css_rules as $rule ) {
		$declarations = wp_get_state_declarations_with_fallback_dimension_styles( $rule['declarations'] );
