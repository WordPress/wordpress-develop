 ...
 */
function wp_disallowed_list_check( $author, $email, $url, $comment, $user_ip, $user_agent ) {
	/**
	 * Fires before the comment is tested for disallowed characters or words.
	 *
	 * @since 1.5.0
	 * @deprecated 5.5.0 Use {@see 'wp_disallowed_list_check'} instead.
	 *
	 ...
	 * @param string $user_agent Comment author's browser user agent.
	 */
	do_action( 'wp_disallowed_list_check', $author, $email, $url, $comment, $user_ip, $user_agent );
