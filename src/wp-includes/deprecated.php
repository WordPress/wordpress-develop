...
function wp_skip_border_serialization( $block_type ) {
	...
	$border_support = $block_type->supports['__experimentalBorder']
		?? false;
...
function wp_skip_dimensions_serialization( $block_type ) {
	...
	$dimensions_support = $block_type->supports['__experimentalDimensions']
		?? false;
...
function wp_skip_spacing_serialization( $block_type ) {
	...
	$spacing_support = $block_type->supports['spacing']
		?? false;
