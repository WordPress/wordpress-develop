 ...
 *
 * @since 1.5.0
 * @deprecated 5.5.0 Use wp_disallowed_list_check() instead.
...
function wp_blacklist_check( $author, $email, $url, $comment, $user_ip, $user_agent ) {
	_deprecated_function( __FUNCTION__, '5.5.0', 'wp_disallowed_list_check()' );

	return wp_disallowed_list_check( $author, $email, $url, $comment, $user_ip, $user_agent );
}
