 ...
 * @since 5.4.0 The `disable-custom-gradients` feature limites to default gradients or gradients added
 ...
 * @since 5.8.0 The `block-template-parts` feature allow to edit any reusable template part from site editor.
 ...
 * @since 6.1.0 The `link-color` feature allows to enable the link color setting.
 * @since 6.3.0 The `border` feature allows themes without theme.json to add border styles to blocks.
 * @since 6.4.0 The `block-templates` feature allow to add editable block templates to post or page.
