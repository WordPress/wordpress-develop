		...
		$this->l10n = array_merge(
			...
			array(
				...
				'missing_attachment'         => sprintf(
					...
					__( 'We can not find that video. Check your <a href="%s">media library</a> and make sure it was not deleted.' ),
				...
				'unsupported_file_type'      => sprintf( __( 'Sorry, we can not load the video at the supplied URL. Please check that the URL is for a supported video file (%s) or stream (e.g. YouTube and Vimeo).' ), '<code>.' . implode( '</code>, <code>.', wp_get_video_extensions() ) . '</code>' ),
			)
		);
	}
