<?php
/**
 * Hooks and utilities for Navigation in the Block Editor.
 *
 * @package gutenberg
 */
 ...
 * @return array
 */
function wp_preload_navigation_posts( $preload_paths, $context ) {
...
add_filter( 'block_editor_rest_api_preload_paths', 'wp_preload_navigation_posts', 10, 2 );
