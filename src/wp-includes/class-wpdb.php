...
class wpdb {
	 ...
	 *
	 * @param int $blog_id
	 * @param int $network_id Optional. Default 0.
	 ...
	 * @since 3.0.0
	 *
	 * @param int $blog_id Optional. Default null.
	 ...
	 * @param mysqli|resource $dbh Optional database connection. Default null.
	 */
	 ...
	 *                       of each row's first column's value. Duplicate keys are discarded. Default OBJECT.
