...
class WP_Image_Editor_Imagick extends WP_Image_Editor {
	...
	public function get_dominant_color() {
		...
		try {
			...
			return new WP_Error( 'image_editor_dominant_color_error', sprintf( __( 'Dominant color detection failed: %s' ), $e->getMessage() ) );
		}
	}
	...
	public function has_transparency() {
		...
		try {
			...
			/* translators: %s is the error message */
			return new WP_Error( 'image_editor_has_transparency_error', sprintf( __( 'Transparency detection failed: %s' ), $e->getMessage() ) );
		}
	}
}
