...
class WP_Theme_JSON {
	 ...
	 * @param array $origins A list of origins to include. By default it includes `static::VALID_ORIGINS`.
	 * @return string Stylesheet.
	 */
	public function get_stylesheet( $types = array( 'variables', 'styles', 'presets' ), $origins = static::VALID_ORIGINS ) {
		if ( is_string( $types ) ) {
	 ...
	 */
	protected static function get_settings_slugs( $settings, $preset_metadata, $origins = static::VALID_ORIGINS ) {
		$preset_per_origin = _wp_array_get( $settings, $preset_metadata['path'], array() );
	 ...
	 * @return array Returns the modified $declarations.
	 */
	protected static function compute_style_properties( $styles, $settings = array(), $properties = static::PROPERTIES_METADATA ) {
		$declarations = array();
		if ( empty( $styles ) ) {
			return $declarations;
		}
