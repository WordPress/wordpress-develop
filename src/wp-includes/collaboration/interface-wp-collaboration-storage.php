 ...
 * @since 7.0.0
 *
 * @phpstan-type AwarenessState array{client_id: string, state: array<string, mixed>, wp_user_id: int}
 */
interface WP_Collaboration_Storage {
	 ...
	 * @return bool True on success, false on failure.
	 */
	public function set_awareness_state( string $room, string $client_id, array $state, int $wp_user_id ): bool;
}
