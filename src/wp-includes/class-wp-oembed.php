...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://(www\.)?x\.com/\w{1,15}/status(es)?/.*#i' => array( 'https://publish.twitter.com/oembed', true ),
			'#https?://(www\.)?x\.com/\w{1,15}$#i'         => array( 'https://publish.twitter.com/oembed', true ),
			'#https?://(www\.)?x\.com/\w{1,15}/likes$#i'   => array( 'https://publish.twitter.com/oembed', true ),
			'#https?://(www\.)?x\.com/\w{1,15}/lists/.*#i' => array( 'https://publish.twitter.com/oembed', true ),
			'#https?://(www\.)?x\.com/\w{1,15}/timelines/.*#i' => array( 'https://publish.twitter.com/oembed', true ),
			'#https?://(www\.)?x\.com/i/moments/.*#i'      => array( 'https://publish.twitter.com/oembed', true ),
