		...
		<div class="date-time-fields {{ data.includeTime ? 'includes-time' : '' }}">
			<fieldset class="day-row">
				...
				<div class="day-fields clear">
					<?php ob_start(); ?>
					<label for="{{ idPrefix }}date-time-month" class="screen-reader-text"><?php /* translators: hidden accessibility text */ esc_html_e( 'Month' ); ?></label>
					...
					<?php ob_start(); ?>
					<label for="{{ idPrefix }}date-time-day" class="screen-reader-text"><?php /* translators: hidden accessibility text */ esc_html_e( 'Day' ); ?></label>
					...
					<?php ob_start(); ?>
					<label for="{{ idPrefix }}date-time-year" class="screen-reader-text"><?php /* translators: hidden accessibility text */ esc_html_e( 'Year' ); ?></label>
			...
			<# if ( data.includeTime ) { #>
				<fieldset class="time-row clear">
					...
					<div class="time-fields clear">
						<label for="{{ idPrefix }}date-time-hour" class="screen-reader-text"><?php /* translators: hidden accessibility text */ esc_html_e( 'Hour' ); ?></label>
						...
						:
						<label for="{{ idPrefix }}date-time-minute" class="screen-reader-text"><?php /* translators: hidden accessibility text */ esc_html_e( 'Minute' ); ?></label>
						...
						<# if ( data.twelveHourFormat ) { #>
							<label for="{{ idPrefix }}date-time-meridian" class="screen-reader-text"><?php /* translators: hidden accessibility text */ esc_html_e( 'Meridian' ); ?></label>
