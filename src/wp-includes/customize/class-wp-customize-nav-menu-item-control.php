			...
			<div class="menu-item-handle">
				...
				<span class="item-controls">
					...
					<?php
						...
						printf( __( 'Edit menu item: %1$s (%2$s), sub-item (level %3$d)' ), '{{ data.title || data.original_title || wp.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}', '{{data.depth}}' );
					?>
