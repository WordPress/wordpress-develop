	...
	public function print_header_image_template() {
		...
		<script type="text/template" id="tmpl-header-choice">
			...
			<button type="button" class="choice thumbnail"
				...
				<span class="screen-reader-text"><?php /* translators: hidden accessibility text */ _e( 'Set image' ); ?></span>
				<img src="{{data.header.thumbnail_url}}" alt="{{data.header.alt_text || data.header.description}}" />
			</button>

			<# if ( data.type === 'uploaded' ) { #>
				<button type="button" class="dashicons dashicons-no close"><span class="screen-reader-text"><?php /* translators: hidden accessibility text */ _e( 'Remove image' ); ?></span></button>
			<# } #>
