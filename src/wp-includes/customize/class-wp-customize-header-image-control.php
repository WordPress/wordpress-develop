	...
	public function render_content() {
		...
		<div class="customize-control-content">
			...
			<div class="actions">
				...
				<button type="button" class="button new <?php echo $this->get_current_image_src() ? '' : 'upload-button'; ?>" id="header_image-button" aria-label="<?php esc_attr_e( 'Add Header Image' ); ?>"><?php _e( 'Add Image' ); ?></button>
				<?php endif; ?>
			</div>
			<div class="choices">
