...
final class WP_Theme implements ArrayAccess {
	...
	private function get_pattern_cache() {
		...
		$pattern_data = wp_cache_get( 'wp_theme_patterns_' . $this->stylesheet, 'theme_files', false, $found, true );
	...
	private function set_pattern_cache( array $patterns ) {
		...
		wp_cache_set( 'wp_theme_patterns_' . $this->stylesheet, $pattern_data, 'theme_files', 0, true );
	}
	...
	public function delete_pattern_cache() {
		wp_cache_delete( 'wp_theme_patterns_' . $this->stylesheet, 'theme_files', true );
	}
