...
add_action( 'do_pings', 'do_pingbacks', 10, 0 );
add_action( 'do_pings', 'do_enclosures', 10, 0 );
add_action( 'do_pings', 'do_tracksbacks', 10, 0 );
add_action( 'do_pings', 'generic_ping', 10, 0 );
