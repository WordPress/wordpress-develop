...
class WP_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$title       = esc_html__( 'XML Sitemap' );
		$description = sprintf(
			/* translators: %s: URL to sitemaps documentation. */
			__( 'This XML Sitemap is generated by WordPress to make your content more visible for search engines. Learn more about XML sitemaps on <a href="%s">sitemaps.org</a>.' ),
			__( 'https://www.sitemaps.org/' )
		);
		$text        = sprintf(
			/* translators: %s: number of URLs. */
			__( 'Number of URLs in this XML Sitemap: %s.' ),
		...
		$changefreq = esc_html__( 'Change Frequency' );
		$priority   = esc_html__( 'Priority' );
