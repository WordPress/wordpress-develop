...
class WP_REST_Attachments_Controller extends WP_REST_Posts_Controller {
	...
	protected function get_edit_media_item_args() {
		return array(
			...
			'x'        => array(
				'description' => __( 'As a percentage of the original image, the x position to start the crop from.' ),
				'type'        => 'number',
				'minimum'     => 0,
				'maximum'     => 100,
			),
			'y'        => array(
				'description' => __( 'As a percentage of the original image, the y position to start the crop from.' ),
				'type'        => 'number',
				'minimum'     => 0,
				'maximum'     => 100,
			),
			'width'    => array(
				'description' => __( 'As a percentage of the original image, the width to crop the image to.' ),
				'type'        => 'number',
				'minimum'     => 0,
				'maximum'     => 100,
			),
			'height'   => array(
				'description' => __( 'As a percentage of the original image, the height to crop the image to.' ),
				'type'        => 'number',
				'minimum'     => 0,
				'maximum'     => 100,
			),
