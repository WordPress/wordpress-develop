...
class WP_REST_Menus_Controller extends WP_REST_Terms_Controller {
	...
	/**
	 * Checks if a request is shown in the REST API endpoint.
	 *
	 * @param  int  $term_id ID of the term.
	 * @return bool True if the term_id belongs to a term that is accessible through REST, otherwise false.
	 */
