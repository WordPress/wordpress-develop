			...
			<fieldset class="signup-options">
				...
				<p class="wp-signup-radio-buttons">
					<span class="wp-signup-radio-button">
						...
						<label class="checkbox" for="signupblog"><?php _ex( 'Give me a site!', 'Multisite signup', $domain ); ?></label>
					</span>
					<span class="wp-signup-radio-button">
						<input id="signupuser" type="radio" name="signup_for" value="user" <?php checked( $signup_for, 'user' ); ?> />
						<label class="checkbox" for="signupuser"><?php _ex( 'Just a username, please.', 'Multisite signup', $domain ); ?></label>
					</span>
				</p>
			</fieldset>
		<?php endif; ?>
