...
switch ( $action ) {
	...
	case 'rp':
		...
		?>
		<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=resetpass&user=' . rawurlencode( $rp_login ), 'login_post' ) ); ?>" method="post" autocomplete="off">
