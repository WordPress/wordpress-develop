...
require ABSPATH . WPINC . '/class-wp-html-attribute-token.php';
require ABSPATH . WPINC . '/class-wp-html-span.php';
require ABSPATH . WPINC . '/class-wp-html-text-replacement.php';
require ABSPATH . WPINC . '/class-wp-html-tag-processor.php';
