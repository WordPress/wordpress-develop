...
require ABSPATH . WPINC . '/xml-api/class-wp-xml-decoder.php';
require ABSPATH . WPINC . '/xml-api/class-wp-xml-tag-processor.php';
require ABSPATH . WPINC . '/xml-api/class-wp-xml-processor.php';
