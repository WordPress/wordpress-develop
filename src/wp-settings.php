...
/*
 * Conditionally load Gutenberg build files if they exist.
 * These files are generated by running `npm run gutenberg:integrate`
 * and provide route-based navigation and full-page rendering for admin pages.
 * Core continues to work without these files - they enable additional features.
 */
