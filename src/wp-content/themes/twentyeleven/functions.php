...
function twentyeleven_scripts_styles() {
	...
	wp_enqueue_style( 'twentyeleven-block-style', get_template_directory_uri() . '/blocks.css', array(), '20221025' );
}
...
function twentyeleven_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'twentyeleven-block-editor-style', get_template_directory_uri() . '/editor-blocks.css', array(), '20221025' );
}
