...
if ( ! function_exists( 'twentyeleven_setup' ) ) :
	...
	function twentyeleven_setup() {
		 ...
		 */
		add_image_size( 'large-feature', $custom_header_support['width'], $custom_header_support['height'], true, array( 'image/webp' ) );
		// Used for featured posts if a large-feature doesn't exist.
		add_image_size( 'small-feature', 500, 300, false, array( 'image/webp' ) );
