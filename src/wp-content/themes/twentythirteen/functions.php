...
function twentythirteen_scripts_styles() {
	...
	wp_enqueue_style( 'twentythirteen-style', get_stylesheet_uri(), array(), '20241014' );

	// Theme block stylesheet.
	wp_enqueue_style( 'twentythirteen-block-style', get_template_directory_uri() . '/css/blocks.css', array( 'twentythirteen-style' ), '20241014' );
...
function twentythirteen_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'twentythirteen-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css', array(), '20241014' );
	// Add custom fonts.
	$font_version = ( 0 === strpos( (string) twentythirteen_fonts_url(), get_template_directory_uri() . '/' ) ) ? '20230328' : null;
	wp_enqueue_style( 'twentythirteen-fonts', twentythirteen_fonts_url(), array(), $font_version );
}
