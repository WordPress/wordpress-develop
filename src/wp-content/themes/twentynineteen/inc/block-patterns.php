...
if ( function_exists( 'register_block_pattern' ) ) {
	...
	register_block_pattern(
			...
			array(
					...
					'categories'    => array( 'twentynineteen' ),
					'viewportWidth' => 1400,
					'content'       => '<!-- wp:heading --> <h2>' . esc_html__( 'Team', 'twentynineteen' ) . '</h2> <!-- /wp:heading --> <!-- wp:media-text {"mediaType":"image","mediaWidth":28,"imageFill":true} --> <div class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill" style="grid-template-columns:28% auto"><figure class="wp-block-media-text__media"><img src="' . esc_url( get_template_directory_uri() ) . '/images/pattern_01.jpg" alt="' . esc_html__( 'Gradient', 'twentynineteen' ) . '"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":3} --> <h3>' . esc_html__( 'Eva Young', 'twentynineteen' ) . '</h3> <!-- /wp:heading --> <!-- wp:paragraph --> <p>' . esc_html__( 'Eva Young grew up working alongside her parents at their restaurant in Queens, NY. She opened Eva Young Consulting in 2014 to help small businesses like her parents’ restaurant adapt to the digital age.', 'twentynineteen' ) . '</p> <!-- /wp:paragraph --></div></div> <!-- /wp:media-text --> <!-- wp:media-text {"mediaType":"image","mediaWidth":28,"imageFill":true} --> <div class="wp-block-media-text alignwide is-stacked-on-mobile is-image-fill" style="grid-template-columns:28% auto"><figure class="wp-block-media-text__media"><img src="' . esc_url( get_template_directory_uri() ) . '/images/pattern_02.jpg" alt="' . esc_html__( 'Gradient', 'twentynineteen' ) . '"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":3} --> <h3>' . esc_html__( 'Doug Watson', 'twentynineteen' ) . '</h3> <!-- /wp:heading --> <!-- wp:paragraph --> <p>' . esc_html__( 'Oddly enough, Doug Watson also grew up working alongside his parents at a family-owned restaurant in Queens, NY. He &nbsp;worked on digital campaigns for Fortune 500 Companies before joining Eva Green Consulting.', 'twentynineteen' ) . '</p> <!-- /wp:paragraph --></div></div> <!-- /wp:media-text -->',
			)
	);
