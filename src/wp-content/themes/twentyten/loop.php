...
while ( have_posts() ) :
	...
	<?php if ( ( function_exists( 'get_post_format' ) && get_post_format( $post->ID ) === 'gallery' ) || in_category( _x( 'gallery', 'gallery category slug', 'twentyten' ) ) ) : ?>
...
<?php endif; ?>
	...
	<?php elseif ( ( function_exists( 'get_post_format' ) && get_post_format( $post->ID ) === 'aside' ) || in_category( _x( 'asides', 'asides category slug', 'twentyten' ) ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
