...
function twentyseventeen_setup() {
	...
	add_image_size( 'twentyseventeen-featured-image', 2000, 1200, true, array( 'image/webp' ) );

	add_image_size( 'twentyseventeen-thumbnail-avatar', 100, 100, true, array( 'image/webp' ) );
