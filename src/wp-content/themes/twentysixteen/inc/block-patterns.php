...
if ( function_exists( 'register_block_pattern' ) ) {
	register_block_pattern(
		...
		array (
            ...
            <h6 style="font-size:35px;line-height:1.5"><strong>Twenty Sixteen is a modernized take on an ever-popular WordPress layout — the horizontal masthead with an optional right sidebar that works perfectly for blogs and websites.</strong></h6>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.8"}}} -->
            <p style="line-height:1.8">It has custom color options with beautiful default color schemes, a harmonious fluid grid using a mobile-first approach, and impeccable polish in every detail. Twenty Sixteen will make your WordPress look beautiful everywhere.</p>
            <!-- /wp:paragraph -->
            <!-- wp:spacer {"height":60} -->
            <div style="height:60px" aria-hidden="true" class="wp-block-spacer"></div>
            <!-- /wp:spacer --></div></div>
	...
	register_block_pattern(
		...
		array (
            ...
            <h1 style="font-size:55px">Lonesome ghosts hovering their chairs</h1>
            <!-- /wp:heading -->
	...
	register_block_pattern(
		...
		array (
            ...
            <h2 style="font-size:40px;line-height:1.5"><em>Twenty Sixteen will make your WordPress look beautiful everywhere.</em></h2>
            <!-- /wp:heading -->
            
            <!-- wp:paragraph {"textColor":"medium-gray"} -->
            <p class="has-medium-gray-color has-text-color">— Takashi Irie</p>
            <!-- /wp:paragraph -->
	...
	register_block_pattern(
		...
		array (
            ...
            <h1 style="font-size:35px;line-height:1.5">My new book “Sail On” is available for pre-order on Amazon.</h1>
            <!-- /wp:heading -->
            ...
            <div class="wp-block-button"><a class="wp-block-button__link has-bright-blue-background-color has-background no-border-radius">Pre-Order Now</a></div>
            <!-- /wp:button --></div>
            <!-- /wp:buttons --></div>
            <!-- /wp:column -->
