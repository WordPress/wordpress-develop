...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"1rem","right":"0px","bottom":"1rem","left":"0px"}}},"backgroundColor":"primary"} -->
					...
					<figure class="wp-block-image size-full"><img width="3001" height="246" src="' . esc_url( get_template_directory_uri() ) . '/assets/images/divider-white.png" alt="" class="wp-image-473"/></figure>
					<!-- /wp:image --></div>
					<!-- /wp:group -->',
);
