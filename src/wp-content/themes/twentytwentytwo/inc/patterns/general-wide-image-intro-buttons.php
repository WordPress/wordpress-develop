...
return array(
	...
	'content'    => '<!-- wp:group {"align":"wide"} -->
				...
				<figure class="wp-block-image size-large"><img width="2100" height="994" src="' . esc_url( get_template_directory_uri() ) . '/assets/images/flight-path-on-gray-a.jpg" alt="' . esc_attr__( 'Illustration of a bird flying.', 'twentytwentytwo' ) . '"/></figure>
				<!-- /wp:image -->
