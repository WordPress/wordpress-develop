	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group alignfull">
			...
			<div class="wp-block-group">
				<!-- wp:navigation {"ariaLabel":"<?php esc_attr_e( 'Footer 1' ); ?>","overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"}} -->
				...
				<!-- wp:navigation {"ariaLabel":"<?php esc_attr_e( 'Footer 2' ); ?>","overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"}} -->
