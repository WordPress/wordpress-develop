 ...
 * Version: 0.1
 * Update ID: dd32.id.au/example-hello-dolly
*/

add_filter( 'update_plugins_' . 'dd32.id.au', function( $update, $headers, $file, $locales ) {
	if ( 'dd32.id.au/example-hello-dolly' === $headers['UpdateID'] ) {
		return [
			//'slug'       => $headers['UpdateID'], // Make sure to filter the plugin details iframe for this value.
			'version'      => '2.0',
