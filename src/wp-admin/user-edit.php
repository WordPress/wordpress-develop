					...
					<?php if ( $show_password_fields ) : ?>
						...
						<table class="form-table" role="presentation">
								...
								<td>
									...
									<div class="wp-pwd hide-if-js">
										<span class="password-input-wrapper">
											<input type="password" name="pass1" id="pass1" class="regular-text" value="" spellcheck="false" autocomplete="new-password" data-pw="<?php echo esc_attr( wp_generate_password( 24 ) ); ?>" aria-describedby="pass-strength-result" />
										</span>
							...
							<tr class="user-pass2-wrap hide-if-js">
								...
								<td>
								<input name="pass2" type="password" id="pass2" class="regular-text" value="" spellcheck="false" autocomplete="new-password" aria-describedby="pass2-desc" />
									<?php if ( IS_PROFILE_PAGE ) : ?>
