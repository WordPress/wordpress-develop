			...
			<form id="your-profile" action="<?php echo esc_url( self_admin_url( IS_PROFILE_PAGE ? 'profile.php' : 'user-edit.php' ) ); ?>" method="post" novalidate="novalidate"
				...
				<table class="form-table" role="presentation">
					...
					<tr class="user-first-name-wrap">
						...
						<td><input type="text" name="first_name" id="first_name" value="<?php echo esc_attr( $profile_user->first_name ); ?>" <?php if ( IS_PROFILE_PAGE ) : ?>autocomplete="given-name" <?php endif; ?>class="regular-text" /></td>
					</tr>

					<tr class="user-last-name-wrap">
						<th><label for="last_name"><?php _e( 'Last Name' ); ?></label></th>
						<td><input type="text" name="last_name" id="last_name" value="<?php echo esc_attr( $profile_user->last_name ); ?>" <?php if ( IS_PROFILE_PAGE ) : ?>autocomplete="family-name" <?php endif; ?>class="regular-text" /></td>
					</tr>

					<tr class="user-nickname-wrap">
						<th><label for="nickname"><?php _e( 'Nickname' ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></th>
						<td><input type="text" name="nickname" id="nickname" value="<?php echo esc_attr( $profile_user->nickname ); ?>" <?php if ( IS_PROFILE_PAGE ) : ?>autocomplete="nickname" <?php endif; ?>class="regular-text" /></td>
					</tr>
					...
					<tr class="user-email-wrap">
						...
						<td>
							<?php if ( $profile_user->ID === $current_user->ID ) : ?>
								<input type="email" name="email" id="email" aria-describedby="email-description" value="<?php echo esc_attr( $profile_user->user_email ); ?>" <?php if ( IS_PROFILE_PAGE ) : ?>autocomplete="email" <?php endif; ?>class="regular-text ltr" />
