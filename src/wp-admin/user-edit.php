...
<tr class="user-display-name-wrap">
	...
	<tr class="user-email-wrap">
		...
		<p class="description" id="email-description">
			<?php _e( 'If you change this, an email will be sent to your new address to confirm it. <strong>The new address will not become active until confirmed.</strong>' ); ?>
		</p>
			<?php
		endif;
