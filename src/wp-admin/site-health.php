...
<div class="health-check-header">
	...
	<nav class="health-check-tabs-wrapper hide-if-no-js" aria-label="<?php esc_attr_e( 'Secondary menu' ); ?>">
		<a href="<?php echo esc_url( self_admin_url( 'site-health.php' ) ); ?>" class="health-check-tab active" aria-current="true">
			<?php
		...
		<a href="<?php echo esc_url( self_admin_url( 'site-health.php?tab=debug' ) ); ?>" class="health-check-tab">
			<?php
