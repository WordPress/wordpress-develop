...
get_current_screen()->add_help_tab(
	array(
		'id'      => 'overview',
		'title'   => __( 'Overview' ),
		'content' => '<p>' . __( 'This screen allows you to manage requests for an export of personal data.' ) . '</p>' .
			'<p>' . __( 'Providing an export of all data that a business or website has collected about an individual is a requirement of many Privacy Laws around the world.' ) . '</p>',
	)
);
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' => '<p>' . __( 'Personal data that is collected by WordPress and that is displayed in the export files include:' ) . '</p>' .
...
get_current_screen()->add_help_tab(
	array(
		...
		'<p>' . __( 'If you are not sure, check plugin documentation or with the plugin author to see if the plugin collects data and supports the Data Exporter tool. This information may be available in your site <a href="/privacy-policy-guide.php">Privacy Policy Guide</a>.' ) . '</p>',
	)
);
...
<div class="wrap nosubsub">
	...
	<p><?php _e( 'This tool helps site owners comply with local laws and regulations by exporting known data for a given user in a .zip file. This is sometimes referred to as the "Right To Data Portability".' ); ?></p>
<p><?php _e( 'The tool associates data stored in WordPress by a supplied email address, including profile data and comments.' ); ?></p>
<p><?php _e( 'Note: As this tool ONLY gathers data from WordPress and participating plugins, you may need to do more to comply with export requests. You should also send the requestor any data collected by or stored with any 3rd party services used by your business or site.' ); ?></p>
