	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column about__image">
				<img src="data:image/svg+xml,%3Csvg width='269' height='120' xmlns='http://www.w3.org/2000/svg'%3E%3Crect x='0' y='0' width='100%25' height='100%25' fill='%23ddd' /%3E%3Ctext text-anchor='middle' font-family='sans-serif' font-size='24' y='50%25' x='50%25'%3EVideo%3C/text%3E%3C/svg%3E" alt="" />
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column about__image">
				<img src="data:image/svg+xml,%3Csvg width='269' height='120' xmlns='http://www.w3.org/2000/svg'%3E%3Crect x='0' y='0' width='100%25' height='100%25' fill='%23ddd' /%3E%3Ctext text-anchor='middle' font-family='sans-serif' font-size='24' y='50%25' x='50%25'%3EImage%3C/text%3E%3C/svg%3E" alt="" />
			</div>
		</div>
			...
			<div class="column about__image">
				<div class="about__image-comparison">
					<div class="about__image-comparison-resize">
						<img src="https://ryelle.codes/core/colors/screenshots-branch/ss-0.png" />
					</div>
					<img src="https://ryelle.codes/core/colors/screenshots/ss-0.png" />
				</div>
			</div>
		</div>
		...
		<div class="about__section has-2-columns has-subtle-background-color">
			<div class="column">
				<p>
					<?php
					printf(
						/* translators: 1: WCAG information link. */
						__( 'This new streamlined color palette collapses all the colors that used to be in the WordPress source code down to seven core colors and a range of 56 shades that meet the <a href="%1$s">WCAG 2.0 AA recommended contrast ratio</a> against white or black.' ),
			...
			<div class="column">
				...
				<p>
					...
					printf(
						/* translators: 1: WCAG information link. */
						__( 'Find the new palette in the default WordPress Dashboard color scheme, and use it when you’re building themes, plugins, or any other components. For all the details, <a href="">check out the Color Palette dev note</a>.' ),
						'#'
					);
					?>
				</p>
