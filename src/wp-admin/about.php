...
?>
	<div class="wrap about__container">
		...
		<div class="about__section has-3-columns">
			<h3 class="is-section-header" style="padding-bottom:0;"><?php _e( 'Get more ways to manage all your site&#8217;s styles' ); ?></h3>
			<div class="column">
				<div class="about__image">
					<img src="data:image/svg+xml,%3Csvg width='436' height='436' viewbox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='%231d35b4' /%3E%3C/svg%3E" alt="" />
				</div>
				<h4><?php _e( 'Style Book' ); ?></h4>
			...
			<div class="column">
				...
				<h4><?php _e( 'Copy and paste styles' ); ?></h4>
