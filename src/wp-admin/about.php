			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Want to dive into 5.9 but don&#8217;t know where to start? Visit <a href="%s">learn.wordpress.org/courses</a> for expanding resources on new features in WordPress 5.9.' ),
						'http://learn.wordpress.org/courses'
					);
					?>
				</p>
			</div>
