...
?>
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns has-accent-4-background-color is-wider-right">
			...
			<div class="column is-vertically-aligned-bottom is-edge-to-edge">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/1-Twenty-Twenty-Four.webp" alt="Twenty Twenty-Four Image" height="600" width="600" />
				</div>
			</div>
		</div>
		...
		<div class="about__section has-3-columns">
			<div class="column">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/2-image-lightbox.webp" alt="About Image" height="270" width="270" />
				</div>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Enjoy <a href="%s" title="Command Palette">a refreshed design and more commands</a> to find what you\'re looking for, perform tasks efficiently, and save time as you create.' ),
		...
		<div class="about__section has-3-columns">
			<div class="column">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/5-renaming-groups.webp" alt="Renaming Groups Image" height="270" width="270" />
				</div>
			...
			<div class="column">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/6-image-preview.webp" alt="About Image" height="270" width="270" />
				</div>
			...
			<div class="column">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/7-import-export-patterns.webp" alt="Import Export Patterns Image" height="270" width="270" />
				</div>
		...
		<div class="about__section has-2-columns has-subtle-background-color is-wider-left">
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/8-captured-toolbar.webp" alt="Captured Toolbar Image" height="434" width="536" />
				</div>
			</div>
			<div class="column is-vertically-aligned-center">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/9-design-tools.webp" alt="Design Tools Image" height="355" width="436" />
				</div>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
					<img src="https://s.w.org/images/core/6.4/10-block-hooks.webp" alt="Block Hooks Image" height="436" width="436" />
				</div>
			</div>
			<div class="column is-vertically-aligned-center">
		...
		<div class="about__section has-3-columns">
			<div class="column about__image is-vertically-aligned-top">
				<img src="<?php echo esc_url( admin_url( 'images/about-release-badge.svg?ver=6.4' ) ); ?>" alt="Release Badge Image" height="270" width="270" />
			</div>
			...
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					...
					printf(
						...
						__( '<a href="%1$s" title="Wordpress Release Notes">Read the WordPress %2$s Release Notes</a> for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ),
						sprintf(
...
__( 'Important! Your version of WordPress (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s" title="Latest version of Wordpress">update to the latest version of WordPress</a>.' );

/* translators: 1: WordPress version number, 2: Link to update WordPress */
__( 'Important! Your version of WordPress (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s" title="Latest version of Wordpress">update to the latest version of WordPress</a>.' );
