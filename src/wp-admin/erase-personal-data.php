...
get_current_screen()->add_help_tab(
	array(
		'id'      => 'overview',
		'title'   => __( 'Overview' ),
		'content' => '<p>' . __( 'This screen allows you to manage requests to erase or delete personal data.' ) . '</p>' .
			'<p>' . __( 'Deleting, anonymizing, or forgetting all data that a business or website has collected about an individual is a requirement of many Privacy Laws around the world.' ) . '</p>',
	)
);
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' => '<p>' . __( 'Personal data that is collected by WordPress and that is deleted or anonymized include:' ) . '</p>' .
...
get_current_screen()->add_help_tab(
	array(
		...
		'<p>' . __( 'If you are not sure, check plugin documentation or with the plugin author to see if the plugin collects data and if it supports the Data Eraser tool. This information may be available in your site <a href="/privacy-policy-guide.php">Privacy Policy Guide</a>.' ) . '</p>',
	)
);
...
<div class="wrap nosubsub">
	...
	<p><?php _e( 'This tool helps site owners comply with local laws and regulations by deleting or anonymizing known data for a given user. This is sometimes referred to as the "Right To Be Forgotten".' ); ?></p>  
<p><?php _e( 'The tool associates data stored in WordPress by a supplied email address, including profile data and comments.' ); ?></p>
<p><?php _e( 'Note: As this tool ONLY gathers data from WordPress and participating plugins, you may need to do more to comply with erasure requests. You should also erase any data collected by or stored with any 3rd party services used by your business or site.' ); ?></p>
