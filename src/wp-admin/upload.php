	...
	get_current_screen()->add_help_tab(
		array(
			...
			'content' =>
				...
				'<p>' . __( 'Use the arrow buttons at the top of the dialog, or <code>alt</code>/<code>option</code> plus the left or right arrow keys on your keyboard, to navigate between media items quickly.' ) . '</p>' .
