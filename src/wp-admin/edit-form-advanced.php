...
if ( 'post' === $post_type ) {
	...
	$title_and_editor .= '<p>' . __( 'Visual mode gives you an editor that is similar to a word processor. Use the toolbar button to show or hide a second row of controls.' ) . '</p>';
