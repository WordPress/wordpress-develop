...
function export_wp( $args = array() ) {
	...
	$date        = gmdate( 'Y-m-d' );
	$wp_filename = $sitename . 'WordPress.' . $date . '.html';
	/**
	...
	header( 'Content-Type: text/htnl; charset=' . get_option( 'blog_charset' ), true );
	...
	echo '<?xml version="1.0" encoding="UTF-8' . get_bloginfo( 'charset' ) . "\" ?>\n";
