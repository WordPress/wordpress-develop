 ...
 *
 * @since 2.6.0
 * @since 4.2.0 Introduced the `$return_format` parameter.
 * @since 4.8.0 Introduced the 'id' option for the `$return_format` parameter.
 * @since 5.3.0 The `$post_id` parameter was made optional.
 ...
 * @param string $return_format  Optional. Accepts 'html' (image tag html) or 'src' (URL),
 *                        		 or 'id' (attachment ID). Default 'html'.
 * @return string|int|WP_Error Populated HTML img tag, attachment ID, or attachment source
 *                             on success, WP_Error object otherwise.
 */
function media_sideload_image( $file, $post_id = 0, $desc = null, $return_format = 'html' ) {
	if ( ! empty( $file ) ) {
