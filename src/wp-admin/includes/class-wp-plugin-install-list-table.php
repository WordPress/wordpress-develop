	...
	public function display_rows() {
		...
		<div class="plugin-card plugin-card-<?php echo sanitize_html_class( $plugin['slug'] ); ?>">
			...
			if ( ! $compatible_php || ! $compatible_wp ) {
				...
				if ( ! $compatible_php && ! $compatible_wp ) {
					echo wp_get_compatibility_string( 'plugin_incompatible_wp_php' );
					...
					echo wp_get_compatibility_string( 'plugin_incompatible_wp' );
					...
					echo wp_get_compatibility_string( 'plugin_incompatible_php' );
