	...
	public function get_test_plugin_version() {
		...
		if ( $plugins_total > $plugins_active && ! is_multisite() ) {
			...
			$result['description'] .= sprintf(
				...
				__( 'Inactive plugins are tempting targets for attackers. If you are not going to use a plugin, we recommend you remove it.' )
			);
				...
				if ( $using_default_theme ) {
					$result['description'] .= sprintf(
						...
						sprintf(
							...
							__( 'To enhance your site&#8217;s security, we recommend you remove any themes you are not using. You should keep your current theme, %1$s, and %2$s, its parent theme.' ),
							$active_theme->name,
					...
					$result['description'] .= sprintf(
						...
						sprintf(
							...
							__( 'To enhance your site&#8217;s security, we recommend you remove any themes you are not using. You should keep %1$s, the default WordPress theme, %2$s, your current theme, and %3$s, its parent theme.' ),
