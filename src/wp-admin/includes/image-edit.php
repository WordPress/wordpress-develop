...
function wp_image_editor( $post_id, $msg = false ) {
	...
	<div class="imgedit-panel-content wp-clearfix">
		...
		<div class="imgedit-submit">
			<input type="button" data-post-id="<?php echo $post_id; ?>" class="button imgedit-cancel-btn" value="<?php esc_attr_e( 'Cancel' ); ?>" />
			<input type="button" disabled="disabled" data-post-id="<?php echo $post_id; ?>" data-nonce="<?php echo $nonce; ?>" class="button button-primary imgedit-submit-btn" value="<?php esc_attr_e( 'Save' ); ?>" />
		</div>
	</div>
	...
	<div class="imgedit-group-top">
		...
		<button type="button" class="dashicons dashicons-editor-help imgedit-help-toggle" aria-expanded="false"><span class="screen-reader-text"><?php esc_html_e( 'Scale Image Help' ); ?></span></button>
		...
		<input type="text" id="imgedit-scale-width-<?php echo $post_id; ?>" data-post-id="<?php echo $post_id; ?>" class="imgedit-scale-width" value="<?php echo isset( $meta['width'] ) ? $meta['width'] : 0; ?>" />
		<span class="imgedit-separator" aria-hidden="true">&times;</span>
		<label for="imgedit-scale-height-<?php echo $post_id; ?>" class="screen-reader-text"><?php _e( 'scale height' ); ?></label>
		<input type="text" id="imgedit-scale-height-<?php echo $post_id; ?>" data-post-id="<?php echo $post_id; ?>" class="imgedit-scale-height" value="<?php echo isset( $meta['height'] ) ? $meta['height'] : 0; ?>" />
		<span class="imgedit-scale-warn" id="imgedit-scale-warn-<?php echo $post_id; ?>">!</span>
		<div class="imgedit-scale-button-wrapper"><input type="button" id="imgedit-scale-button" data-post-id="<?php echo $post_id; ?>" data-nonce="<?php echo $nonce; ?>" class="button button-primary" value="<?php esc_attr_e( 'Scale' ); ?>" /></div>
		</div>
		</fieldset>
	...
	<div class="imgedit-group">
	<div class="imgedit-group-top">
		<h2><button type="button" id="imgedit-restore-original" class="button-link" aria-expanded="false"><?php _e( 'Restore original image' ); ?> <span class="dashicons dashicons-arrow-down imgedit-help-toggle"></span></button></h2>
		...
		<div class="imgedit-submit">
		<input type="button" id="imgedit-restore-button" data-post-id="<?php echo $post_id; ?>" data-nonce="<?php echo $nonce; ?>" class="button button-primary" value="<?php esc_attr_e( 'Restore image' ); ?>" <?php echo $can_restore; ?> />
		</div>
		</div>
	</div>
	</div>
	...
	<div class="imgedit-group-top">
		...
		<button type="button" class="dashicons dashicons-editor-help imgedit-help-toggle" aria-expanded="false"><span class="screen-reader-text"><?php esc_html_e( 'Image Crop Help' ); ?></span></button>
	...
	<fieldset class="imgedit-crop-ratio">
		...
		<input type="text" id="imgedit-crop-width-<?php echo $post_id; ?>" data-post-id="<?php echo $post_id; ?>" class="imgedit-crop-width" />
		...
		<input type="text" id="imgedit-crop-height-<?php echo $post_id; ?>" data-post-id="<?php echo $post_id; ?>" class="imgedit-crop-height" />
		</div>
	</fieldset>
	...
	<fieldset id="imgedit-crop-sel-<?php echo $post_id; ?>" class="imgedit-crop-sel">
		...
		<input type="text" id="imgedit-sel-width-<?php echo $post_id; ?>" data-post-id="<?php echo $post_id; ?>" class="imgedit-sel-width" />
		<span class="imgedit-separator" aria-hidden="true">&times;</span>
		<label for="imgedit-sel-height-<?php echo $post_id; ?>" class="screen-reader-text"><?php _e( 'selection height' ); ?></label>
		<input type="text" id="imgedit-sel-height-<?php echo $post_id; ?>" data-post-id="<?php echo $post_id; ?>" class="imgedit-sel-height" />
		</div>
	</fieldset>
	...
	<div class="imgedit-group-top">
		...
		<button type="button" class="dashicons dashicons-editor-help imgedit-help-toggle" aria-expanded="false"><span class="screen-reader-text"><?php esc_html_e( 'Thumbnail Settings Help' ); ?></span></button>
		<div class="imgedit-help">
