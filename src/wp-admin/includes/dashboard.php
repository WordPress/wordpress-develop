...
function wp_welcome_panel() {
	...
	<div class="welcome-panel-column is-welcome-panel-patterns">
	...
	<div class="welcome-panel-column is-welcome-panel-site-editor">
		<div class="welcome-panel-image"></div>
		<h3><?php _e( 'Customize your entire site' ); ?></h3>
		<p><?php _e( 'With the new editor you can now edit every part of your site using blocks.' ); ?></p>
		<?php if ( $customize_url ) : ?>
			<a class="button button-secondary load-customize hide-if-no-customize" href="<?php echo $customize_url; ?>"><?php _e( 'Customize Your Site' ); ?></a>
		<?php endif; ?>
		<a class="button button-secondary hide-if-customize" href="<?php echo esc_url( admin_url( 'themes.php' ) ); ?>"><?php _e( 'Customize Your Site' ); ?></a>
	</div>
	<div class="welcome-panel-column is-welcome-panel-styles">
		<div class="welcome-panel-image"></div>
