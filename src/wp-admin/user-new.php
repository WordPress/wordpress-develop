...
<table class="form-table" role="presentation">
		...
		<td>
			...
			<div class="wp-pwd">
				...
				<span class="password-input-wrapper">
					<input type="password" name="pass1" id="pass1" class="regular-text" spellcheck="false" autocomplete="new-password" data-reveal="1" data-pw="<?php echo esc_attr( $initial_password ); ?>" aria-describedby="pass-strength-result" />
				</span>
	...
	<tr class="form-field form-required user-pass2-wrap hide-if-js">
		...
		<td>
		<input name="pass2" type="password" id="pass2" spellcheck="false" autocomplete="new-password" aria-describedby="pass2-desc" />
