...
/* translators: 1: Comment date, 2: Comment time. */
		...
		date_i18n( _x( 'M j, Y', 'publish box date format' ), (new DateTimeImmutable( $comment->comment_date ) )->getTimestamp() ),
		/* translators: Publish box time format, see https://www.php.net/manual/datetime.format.php */
		date_i18n( _x( 'H:i', 'publish box time format' ), (new DateTimeImmutable( $comment->comment_date ) )->getTimestamp() )
);
?>
<span id="timestamp">
<?php
