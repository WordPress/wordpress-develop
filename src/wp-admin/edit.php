		...
		array(
			...
			'content' =>
					...
					'<ul>' .
						...
						'<li>' . __( 'You can filter the post list by post status using the text links above the posts list to only show posts with that status. The default view is to show all posts.' ) . '</li>' .
