...
| `wp_ajax_dashboard_widgets` | ❌ Missing                                                        |
| `wp_ajax_logged_in` | created | ✅ [65242](https://core.trac.wordpress.org/ticket/65242)          | `65242-ajax-actions-wp_ajax_logged_in`                  |  |
| `_wp_ajax_add_hierarchical_term` | ❌ Missing                                                        |
| `wp_ajax_delete_tag` | ❌ Missing                                                        |
| `wp_ajax_delete_link` | ❌ Missing                                                        |
| `wp_ajax_delete_meta` | ❌ Missing                                                        |
| `wp_ajax_delete_post` | ❌ Missing                                                        |
| `wp_ajax_trash_post` | ❌ Missing                                                        |
| `wp_ajax_untrash_post` | ❌ Missing                                                        |
| `wp_ajax_delete_page` | ❌ Missing                                                        |
| `wp_ajax_add_link_category` | ❌ Missing                                                        |
| `wp_ajax_get_tagcloud` | ❌ Missing                                                        |
| `wp_ajax_add_menu_item` | ❌ Missing                                                        |
| `wp_ajax_add_user` | ❌ Missing                                                        |
| `wp_ajax_closed_postboxes` | ❌ Missing                                                        |
| `wp_ajax_hidden_columns` | ❌ Missing                                                        |
| `wp_ajax_update_welcome_panel` | ❌ Missing                                                        |
| `wp_ajax_menu_get_metabox` | ❌ Missing                                                        |
| `wp_ajax_wp_link_ajax` | ❌ Missing                                                        |
| `wp_ajax_menu_locations_save` | ❌ Missing                                                        |
| `wp_ajax_meta_box_order` | ❌ Missing                                                        |
| `wp_ajax_menu_quick_search` | ❌ Missing                                                        |
| `wp_ajax_get_permalink` | ❌ Missing                                                        |
| `wp_ajax_sample_permalink` | ❌ Missing                                                        |
| `wp_ajax_inline_save_tax` | ❌ Missing                                                        |
| `wp_ajax_find_posts` | ❌ Missing                                                        |
| `wp_ajax_widgets_order` | ❌ Missing                                                        |
